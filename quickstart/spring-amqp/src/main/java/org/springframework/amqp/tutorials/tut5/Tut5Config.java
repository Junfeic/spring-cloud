...
public class Tut5Config {
	...
	private static class ReceiverConfig {
		...
		@Bean
		public Queue namedQueue() {
			return new Queue("tut.topic.quick", true, false, false, new HashMap<>());
		}
		...
		@Bean
		public Binding binding3a(TopicExchange topic, Queue namedQueue) {
			return BindingBuilder.bind(namedQueue).to(topic).with("quick.#");
		}
